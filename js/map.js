...
function initializeMap() {
 ...
 function getIcon(iconType) {
 	...
 	if (!ICONS[i]) {
 		...
 		else if(i==7) { iconImageURL = "http://www.ie511.org/m4/images/incident7.gif"; }
 		else if(i==8) { iconImageURL = "http://www.ie511.org/m4/images/incident8.gif"; }
...
function addIncidents() {
	...
	downloadUrl(xmlUrl, function(doc) {
		var xmlDoc = xmlParse(doc);
		var markers = xmlDoc.documentElement.getElementsByTagName("Points");
        //alert("XML download success. Markers: " + markers.length);
